<menu class="desktopNav">
	<li class=""><a href="/tdac/" class="accentOrg">Home</a></li>
	...
	<div class="dropdown">
	  ...
	  <div class="dropdown-content">
	    <a href="/tdac/group-activities.php">Group Based Activites</a>
	    <a href="/tdac/overnight-stays.php">Overnight Stays</a>
	    <a href="/tdac/lifeskills.php">Lifeskills</a>
	    <a href="/tdac/one-to-one.php">One to One</a>
	  </div>
	</div>
	<div class="dropdown">
	  <button class="dropbtn">Join Us <img src="icons/downArrow.svg" class="downArrow" alt="Dropdown Arrow"></button>
	  <div class="dropdown-content">
	    <a href="/tdac/register.php">Become a participant</a>
	    <a href="/tdac/careers.php">Join our team!</a>
	  </div>
	</div>
