...
<html lang="en">
  <head>
    <?php
      $page_title = 'What TDAC Really Stands For | TDAC Australia';
      $page_decription = 'We’re not a visa. We’re That Disability Adventure Company (TDAC Australia), offering inclusive adventures and support for people with disabilities.';
      $page_name = '/blog/what-tdac-really-stands-for';
      ...
      <article>
        <section class="articleTitleContainer">
          <section class="textContainerSmaller">
            <h1 class="articleTitle">What TDAC Really Stands For</h1>
            <h2>Empowering Inclusive Adventures and Support for Disabilities</h2>
            <span class="author">By TDAC Team | 28th May 2025 | 6 min read</span>
          </section>
          <img src="img/merch/merchPic4.webp" class="articleImg" alt="TDAC group enjoying an inclusive adventure">
        </section>
        ...
        <section class="mainArticle">
          <section class="textContainer">
            ...
            <section class="paragraphSection">
              <h2>What We Offer</h2>
              <p>TDAC Australia provides a wide variety of inclusive support services tailored to individual needs and interests. Here’s just a taste of what we offer:</p>
              <ul>
                <li>Recurring weekly programs that build life skills through familiarity and structure.</li>
                <li>Group activities and one-on-one support designed to foster friendships and confidence.</li>
                <li>Life skill workshops focused on independence and personal growth.</li>
                <li>Overnight stays for supported getaways that encourage comfort, confidence, and community.</li>
              </ul>
            </section>

            <section class="paragraphSection">
              <h2>Why Names Matter – And Why Ours Stands Out</h2>
              <p>We know the name “TDAC” might now bring up links to immigration paperwork and visa requirements—but let’s not let this overshadow our amazing work!</p>
              <p>At That Disability Adventure Company, TDAC stands for something way more meaningful: inclusion, empowerment, friendship, growth, and most of all—adventure.</p>
              <p>We’re proud to share the acronym, because every click and search gives us the chance to tell the world who we really are; a community-based organisation committed to fun disability support in Victoria, Australia.</p>
            </section>
