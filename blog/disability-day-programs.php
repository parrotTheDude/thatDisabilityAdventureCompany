		...
		<main>
			...
			<article>
				<section class="articleTitleContainer">
					<img src="icons/friends.svg" class="articleIcon">
					<h1 class="articleTitle">Day Program Activities for Adults with Disabilities</h1>
					<span class="author">By Jacob  |  22nd Dec, 2024  |  10 min read</span>
				</section>
				...
				<section class="mainArticle">
					<section class="textContainer">
					  ...
					  <section class="imgContainerArticle">
							<img src="/img/blog/snow-trip.webp" alt="Snow trip">
				  	...
				  	<section class="imgContainerArticle">
							<img src="/img/blog/iFly-day-trip.webp" alt="iFly Day Trip">
